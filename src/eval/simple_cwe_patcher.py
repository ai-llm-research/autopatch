...
class AutoPatchSimpleCWEPatcher:
    ...
    def __init__(self, model):
        ...
        if isinstance(self.model, ChatOpenAI):
            ...
            prompt = ChatPromptTemplate([
                    ...
                    ("ai", textwrap.dedent(
                            """
                            Now, I will patch user-provided [Target Code] having a vulnerabilitiy of {cwe_type}. Then, I will provide the results {format_instructions}

                            Let's think step-by-step.

                            Step 1. Describe how to patch [Target Code] to fix {cwe_type}.
